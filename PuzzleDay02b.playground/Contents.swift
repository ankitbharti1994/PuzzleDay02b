...
// Example Input
let result = Utility.sumOfEvenlyDividedNumbersInSpreadsheet(input: [[5,9,2,8], [9,4,7,3] , [3,8,6,5]])
XCTAssertEqual(result, 9, "result should be 9")
...
let inputValue = Utility.convertStringToArrayOfInt(inputText)
let finalResult = Utility.sumOfEvenlyDividedNumbersInSpreadsheet(input: inputValue)
